...
function updateNewsHTML() {
  ...
  <div style="background:var(--bg3);border-left:3px solid var(--g);border-radius:8px;padding:10px 12px;margin:6px 0;font-size:13px;color:var(--t2);line-height:1.6">⚡ <b style="color:var(--t)">이번엔</b> 로그인·홈 화면에 마스코트 로고를 넣었어요.</div>

  ${S('📣 이번 업데이트')}
  ${li('🐩 <b>마스코트 로고 적용</b> — 로그인 화면의 ⛳와 홈 화면 상단의 "온그린" 옆 ⛳를 앱 아이콘의 강아지 마스코트 이미지로 바꿨어요.')}
